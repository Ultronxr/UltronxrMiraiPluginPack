...
public class StringUtils {
    ...
    public static List<String> splitBySpacesNotInQuotesWithoutQuotes(String str) {
        ...
        Pattern regex = Pattern.compile(GlobalData.Regex.SPLIT_BY_SPACES_NOT_IN_QUOTES);
    ...
    public static List<String> splitBySpacesNotInQuotes(String str) {
        ...
        return ReUtil.findAll(GlobalData.Regex.SPLIT_BY_SPACES_NOT_IN_QUOTES, str, 0);
    }
