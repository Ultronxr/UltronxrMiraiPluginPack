...
public interface RandomService {
     ...
     * 获取指定区间的随机数
     *
     * 这里解释使用 {@link cn.ultronxr.bean.GlobalData.Regex#MATH_INTERVAL} 正则表达式对 整数区间字符串 分组groups的结果
     ...
     *
     * @param regexGroups   使用 {@link cn.ultronxr.bean.GlobalData.Regex#MATH_INTERVAL} 正则表达式对 整数区间字符串 分组groups的结果
